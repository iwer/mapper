...
public class FileHandler {
     ...
     *            the data_
     */
    public FileHandler(FormContainer formContainer) {
        data = formContainer;
    }
    ...
    public void loadXML(String filename) {
        ...
        for (int i = 0; i < pointsElement.length; i++) {
            ...
            Point p = new Point(data.renderLayer, data.getParent(),
                    data.getPointShapeGroup(), id, x, y, data.isShowHelper());
        ...
        for (int i = 0; i < edgesElement.length; i++) {
            ...
            Edge e = new Edge(data.renderLayer, data.getParent(),
                    data.getEdgeShapeGroup(), id, data.getPoints().get(a), data
                            .getPoints().get(b), data.isShowHelper());
        ...
        for (int i = 0; i < facesElement.length; i++) {
            ...
            Face f = new Face(data.renderLayer, data.getParent(),
                    data.getFaceShapeGroup(), id, data.isShowHelper());
