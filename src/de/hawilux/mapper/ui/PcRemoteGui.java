...
public class PcRemoteGui implements IGui {
    ...
    public PcRemoteGui(PApplet parent_, ControlP5 cp5_) {
        ...
        btnLoadConfig = cp5.addButton("loadConfig").setPosition(10, 35)
                .setColor(c).moveTo(fileGroup);
        btnSaveConfig = cp5.addButton("saveConfig").setPosition(10, 60)
                .setColor(c).moveTo(fileGroup);
    ...
    public void addEffectToggle(String effectname, final OscStack oscStack) {
        Toggle t;
        t = cp5.addToggle(effectname.toLowerCase()).setSize(100, 10)
