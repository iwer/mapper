...
public class ServerFileHandler {
    ...
    public void loadXML(String filename) {
        ...
        for (int i = 0; i < pointsElement.length; i++) {
            ...
            ServerPoint p = new ServerPoint(data.getParent(),
                    data.getPointShapeGroup(), data.server, id, x, y,
                    data.isShowHelper());
        ...
        for (int i = 0; i < edgesElement.length; i++) {
            ...
            ServerEdge e = new ServerEdge(data.getParent(),
                    data.getEdgeShapeGroup(), data.server, id, data.getPoints()
                            .get(a), data.getPoints().get(b),
                    data.isShowHelper());
        ...
        for (int i = 0; i < facesElement.length; i++) {
            ...
            ServerFace f = new ServerFace(data.getParent(),
                    data.getFaceShapeGroup(), data.server, id,
                    data.isShowHelper());
